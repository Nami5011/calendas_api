...
class GoogleService
{
	...
	public static function getOauthService($client) {
		return new Google_Service_Oauth2($client);
	}

	// Get user info *Require active token
	public static function getUserinfoOauth($client) {
	...
	public static function getCalendarService($client) {
		return new Google_Service_Calendar($client);
	}

	public static function getCalendarEvent($class) {
		$eventInput = array();
	...
	public static function checkCalendarEventRequest($class) {
